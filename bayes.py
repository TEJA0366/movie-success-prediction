...
with open('/home/muttana/Desktop/dmproject/projectDm/lists/ratings.list') as f:
	for line in f:
		line =  line.lower()
...
with open('/home/muttana/Desktop/dmproject/projectDm/lists/genres.list') as f:
	for line in f:
...
fnames = ['/home/muttana/Desktop/dmproject/projectDm/lists/directors.list','/home/muttana/Desktop/dmproject/projectDm/lists/actors.list','/home/muttana/Desktop/dmproject/projectDm/lists/actresses.list','/home/muttana/Desktop/dmproject/projectDm/lists/writers.list','/home/muttana/Desktop/dmproject/projectDm/lists/composers.list','/home/muttana/Desktop/dmproject/projectDm/lists/cinematographers.list','/home/muttana/Desktop/dmproject/projectDm/lists/producers.list']
...
#with open('/home/muttana/Desktop/dmproject/projectDm/ml-100k/u.genre') as f:
#	for line in f:
#		print line.strip()

def load_movies_ml100k():
	with open('/home/muttana/Desktop/dmproject/projectDm/ml-100k/u.item') as f:
		for line in f:
...
def load_users_ml100k():
	with open('/home/muttana/Desktop/dmproject/projectDm/ml-100k/u.user') as f:
		for line in f:
			lines =  line.strip().split('|')
			users.append(np.array([x for x in lines[1:]]))
			userTotalReview.append(0)
def load_ratings_mlk100():
	with open('/home/muttana/Desktop/dmproject/projectDm/ml-100k/u.data') as f:
		for line in f:
			lines =  line.strip().split('\t')
			userId = int(lines[0])
			movieId = int(lines[1])
...
def load_movies_ml10M():
	with open('/home/muttana/Desktop/dmproject/projectDm/ml-10M/movies.dat') as f:
		for line in f:
			lines = line.strip().split("::")
			movieid = int(lines[0])
...
def load_ratings_ml10M():
	with open('/home/muttana/Desktop/dmproject/projectDm/ml-10M/ratings.dat') as f:
		i=0
		for line in f:
			i+=1
			if (i)%20000 == 0:
